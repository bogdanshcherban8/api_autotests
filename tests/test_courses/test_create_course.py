...
from tools.assertions.courses import assert_create_courses_response
...
class TestCreateCourse:
    def test_create_course(self, create_file:FileData, create_user:UserData, private_courses_client_manual_create_file:PrivateCoursesClient):
        ...
        response = private_courses_client_manual_create_file.create_course_api(request)
        ...
        assert_create_courses_response(request=request, response=response_json)
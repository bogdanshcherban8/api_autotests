...
@allure.step("Check get exercise with incorrect data response")
def assert_get_exercise_with_incorrect_data_response(actual: ValidationErrorResponseSchema):
    logger.info("Check get exercise with incorrect data response")
...
@allure.step("Check get exercises with incorrect data response")
def assert_get_exercises_with_incorrect_data_response(actual: ValidationErrorResponseSchema):
    logger.info("Check get exercises with incorrect data response")
    expected = ValidationErrorResponseSchema(
        details=[
            ValidationErrorSchema(
                type="uuid_parsing",
...
@allure.step("Check update exercise with incorrect data response")
def assert_update_exercise_with_incorrect_data_response(actual: ValidationErrorResponseSchema, incorrect_value,
                                                        location):
    logger.info("Check update exercise with incorrect data response")
    expected = ValidationErrorResponseSchema(
        details=[
            ValidationErrorSchema(
...
@allure.step("Check create exercise with incorrect data response")
def assert_create_exercise_with_incorrect_data_response(actual: ValidationErrorResponseSchema, incorrect_value,
    ...
    logger.info("Check create exercise with incorrect data response")
    expected = ValidationErrorResponseSchema(
        details=[
            ValidationErrorSchema(
                type=type_text,
